...
const FloorExplorer = ({ open, initialFrame, initialRank, onClose, onEnquire }) => {
  ...
  // Share the current residence — the Web Share sheet where it exists,
  // otherwise a clipboard copy with a brief confirmation in its place.
